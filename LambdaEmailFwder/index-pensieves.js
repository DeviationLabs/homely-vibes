...
console.log("AWS Lambda SES Forwarder // @arithmetic // Version 5.0.0 - Pensieves");
...
const defaultConfig = {
  ...
  allowPlusSign: true,
  forwardMapping: {
    // Pensieves domain mappings
    info: ["abutala+pensieves-info@gmail.com"],
...
function findMatchingPattern(inputString, patterns) {
  for (const pattern of patterns) {
    const regex = new RegExp(`^${pattern}$`); // Note: Not tested with the anchors
